...
namespace HeroesWorld.Engine.Graphical.Pastel
{
    internal class ScalableBitmapPainter : IBitmapPainterCommand
    {
        ...
        public void Paint(Size bitmapSize, Graphics g)
        {
            ...
            DrawScaled(
                new Rectangle(_innerRect.Left, _bitmap.Height - _innerRect.Bottom, innerRectWidth, _innerRect.Bottom),
                graphics,
            ...
            DrawCut(
                new Rectangle(_bitmap.Width - _innerRect.Right, _bitmap.Height - _innerRect.Bottom, _innerRect.Right,
                    _innerRect.Bottom),
                graphics,

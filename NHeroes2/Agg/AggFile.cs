...
namespace NHeroes2.Agg
{
    ...
    public class AggFile
    {
     ...
     static byte[] kb_pal = {
        ...
        static Color packRgba(UInt32 r, UInt32 g, UInt32 b, UInt32 a = 255)
        {
        ...
        {
            var r = kb_pal[palette * 3];
            var g = kb_pal[palette * 3+1];
            var b = kb_pal[palette * 3+2];
            var palColor = packRgba(r,g,b);
        ...
        public IcnSprite RenderICNSprite(int icn, int index)
        {
            ...
            // start render
            Size sz = new Size(header1.width, header1.height);
